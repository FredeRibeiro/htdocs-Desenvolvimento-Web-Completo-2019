...
try {
	...
	$mensagem->status['descricao_status'] = 'Não foi possivel enviar este e-mail! Por favor tente novamente mais tarde!<br> Detalhes do erro:' . $mail->ErrorInfo;
}
			...
			<div class="row">
				<div class="col-md-12">
					<?php if ($mensagem->status['codigo_status'] == 1) {?>
						<div class="container">
							<h1 class="display-4 text-success">E-mail enviado com sucesso!</h1>
					...
					<?php if ($mensagem->status['codigo_status'] == 2) {?>
						<div class="container">
							<h1 class="display-4 text-danger">E-mail não enviado!</h1>
							<p><?php $mensagem->status['descricao_status']?></p>
